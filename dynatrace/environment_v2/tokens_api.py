...
SCOPE_ADVANCED_SYNTHETIC_INTEGRATION = (
...
SCOPE_USER_SESSION_ANONYMIZATION = (
...
SCOPE_RUM_JAVA_SCRIPT_TAG_MANAGEMENT = (
...
SCOPE_SYNTHETIC_LOCATIONS_WRITE = (
    "syntheticLocations.write"  # Write synthetic locations.
)
SCOPE_TENANT_TOKEN_ROTATION_WRITE = (
...
class TokenService:
    ...
    def create(
        ...
        personal_access_token: bool | None = None,
...
class ApiToken(DynatraceObject):
    def _create_from_raw_data(self, raw_element):
        self.last_used_date: datetime | None = iso8601_to_datetime(
            raw_element.get("lastUsedDate")
        )
        ...
        self.expiration_date: datetime | None = iso8601_to_datetime(
            raw_element.get("expirationDate")
        )
        self.creation_date: datetime | None = iso8601_to_datetime(
            raw_element.get("creationDate")
        )
